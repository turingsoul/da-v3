(function(global) {
        ...
        function processClone(original, clone) {
            ...
            function cloneStyle() {
                ...
                function copyStyle(source, target) {
                    if (source.cssText)
                        target.cssText = source.cssText.replace(
                            /overflow(-x|-y)?\:\s*\w+;/g,
                            "overflow: hidden;"
                        );
                    //保存图片时不要显示滚动条
    ...
    function newUtil() {
        ...
        function makeImage(uri) {
            domtoimage.ImgObj = domtoimage.ImgObj || {};
            domtoimage.ImgObj[uri] =
                domtoimage.ImgObj[uri] ||
        ...
        function getAndEncode(url) {
            ...
            domtoimage.UrlObj = domtoimage.UrlObj || {};
            domtoimage.UrlObj[url] =
                domtoimage.UrlObj[url] ||
        ...
        function newImage(element) {
            ...
            function inline(get) {
                ...
                let _dataUrl =
                    ...
                    element.src.replace(/(http|https):/g, "");
                return Promise.resolve(_dataUrl)
                    .then(get || util.getAndEncode)
                    .then(function(data) {
                        return util.dataAsUrl(data, util.mimeType(_dataUrl));
                    })
                    .then(function(dataUrl) {
                        return new Promise(function(resolve, reject) {
