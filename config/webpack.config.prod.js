...
module.exports = {
        ...
        splitChunks: {
            ...
            cacheGroups: {
                reactBase: {
                    name: 'reactBase',
                    test: (module) => {
                        return /react|redux|prop-types|antd|ant-design|[\\/]rc-.+[\\/]/.test(module.context);
                    },
                    chunks: 'initial',
                    priority: 30,
                },
                common: {
                    name: 'common',
                    test: (module) => {
                        return /jquery|echarts|moment|underscore/.test(module.context);
                    },
                    chunks: 'initial',
                    priority: 20,
                },
    ...
    plugins: [
        ...
        new ZipPlugin({
            path: paths.appBuild,
            filename:
                "dashboard-v3-" + version + "-" + new Date().getTime() + ".zip",
